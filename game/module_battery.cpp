...
void mark::module::battery::tick(mark::tick_context& context) {
	...
	context.render_bar(m_image_bar, pos + mark::vector<double>(0, -mark::module::size * 2.0), mark::tick_context::bar_type::energy, m_cur_energy / m_max_energy);
	context.render_bar(m_image_bar, pos + mark::vector<double>(0, -mark::module::size * 2.0 + 8.0), mark::tick_context::bar_type::health, m_cur_health / m_max_health);
